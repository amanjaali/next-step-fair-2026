...
<head>
    ...
    <meta property="og:image" content="{{ $ogImage ?? asset('assets/share/'.app()->getLocale().'-student-og.png') }}">
    ...
    <meta name="twitter:image" content="{{ $ogImage ?? asset('assets/share/'.app()->getLocale().'-student-og.png') }}">
