<x-layouts.scholarship :title="$title" :scholarshipNav="$scholarshipNav" :attendee="$attendee" :application="$application">
    <div class="ns-wrap max-w-[760px] pt-[clamp(28px,4vw,56px)] pb-[clamp(72px,10vw,140px)]">
        ...
        <form method="POST" action="{{ route('scholarship.eligibility.save') }}">
            ...
            <div class="flex flex-col gap-px bg-[rgba(5,7,8,0.14)] border border-[rgba(5,7,8,0.14)]">
                @foreach ($questions as $index => $question)
                    <fieldset class="bg-white px-6 py-6 border-0 m-0">
                        ...
                        <p class="ns-body !text-[13.5px] text-body-soft mb-4 ps-[30px] max-w-[54ch]">
            ...
            <button type="submit" class="ns-btn ns-btn-magenta mt-8">{{ __('scholarship.eligibility.submit') }}</button>
