...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.site','data' => ['title' => $title,'description' => $description,'navKey' => $navKey,'track' => 'conference']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($title),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($description),'navKey' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($navKey),'track' => 'conference']); ?>
...
<?php $component->withAttributes(['kicker' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page->t('kicker')),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page->t('title')),'lead' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($page->t('standfirst'))]); ?>
            <div class="flex gap-3 flex-wrap mb-11">
                ...
                <a href="<?php echo e(route('agenda', ['day' => 1])); ?>" class="ns-btn ns-btn-ghost"><?php echo e(__('site.pages.conference.programme')); ?></a>
            </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <section class="mb-11">
                            <div class="flex items-baseline gap-[14px] mb-[14px]">
                                <span class="ns-num font-[family-name:var(--ns-display)] text-[13px] font-bold text-cobalt"><?php echo e($section['n']); ?></span>
                                ...
                                <ul class="list-none m-0 p-0 flex flex-col gap-[10px] mt-5">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $section['list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="font-[family-name:var(--ns-body)] text-base leading-[1.65] text-body-soft flex gap-[14px] max-w-[68ch]">
                                            <span class="ns-bar bg-cobalt mt-[9px]"></span><span><?php echo e($item); ?></span>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </ul>
                ...
                <aside class="flex-[1_1_260px] max-w-[320px] min-w-0">
                        ...
                        <dl class="m-0">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                                ...
                                <div class="flex flex-col gap-[3px] py-[10px] border-b border-[rgba(5,7,8,0.1)]">
                                    ...
                                    <dd class="m-0 font-[family-name:var(--ns-body)] text-sm leading-[1.5] text-body"><?php echo e($value); ?></dd>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <div class="flex flex-col gap-[3px] pt-[10px]">
                                <dt class="ns-eyebrow !text-[9.5px]"><?php echo e(__('site.common.language_of_session')); ?></dt>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! empty($aside['title'])): ?>
                        <div class="ns-card !p-6 mb-5">
                            ...
                            <a href="mailto:<?php echo e($aside['contact']); ?>" class="font-[family-name:var(--ns-body)] text-sm font-bold text-cobalt"><?php echo e($aside['contact']); ?></a>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <div class="ns-panel-ink !p-6">
                        <div class="ns-eyebrow !text-white/50 !text-[10.5px] mb-3"><?php echo e(__('site.cta.conference_rsvp')); ?></div>
                        <a href="<?php echo e(route('register.conference')); ?>" class="ns-btn ns-btn-cobalt w-full"><?php echo e(__('site.cta.conference_rsvp')); ?></a>
                    </div>
                </aside>
            </div>

            <h2 class="ns-h2 !text-[clamp(24px,2.6vw,32px)] mb-6"><?php echo e(__('site.pages.conference.programme')); ?></h2>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($speakers->isNotEmpty()): ?>
                <h2 class="ns-h2 !text-[clamp(24px,2.6vw,32px)] mb-6"><?php echo e(__('site.pages.conference.speakers')); ?></h2>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ns.speaker-card','data' => ['speaker' => $speaker,'showSessions' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['speaker' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($speaker),'showSessions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /Users/amanjali/Downloads/next-step-fair-2026/resources/views/pages/conference.blade.php ENDPATH**/ ?>