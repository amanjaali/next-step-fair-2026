...
<div class="flex h-10 border border-[rgba(5,7,8,0.16)] shrink-0 rounded-[var(--ns-radius-sm)] overflow-hidden" role="group" aria-label="<?php echo e(__('site.nav.language')); ?>">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = config('nextstep.locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $conf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form method="GET" action="<?php echo e(route('locale.switch', $code)); ?>">
            ...
            <button type="submit"
                    class="font-[family-name:'Space_Grotesk'] text-[11px] font-semibold tracking-[0.14em] h-full px-[10px] border-0 cursor-pointer !rounded-none transition-colors duration-200 <?php echo e($code === $locale ? 'bg-ink text-white' : 'bg-transparent text-ink'); ?>"
